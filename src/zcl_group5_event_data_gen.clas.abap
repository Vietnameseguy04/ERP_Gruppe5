CLASS zcl_group5_event_data_gen DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_group5_event_data_gen IMPLEMENTATION.
    METHOD if_oo_adt_classrun~main.

    "===============================================================
    " DATA DECLARATIONS
    "===============================================================
    DATA: lt_events        TYPE TABLE OF zevent_05,
          ls_event         TYPE zevent_05,
          lt_participants  TYPE TABLE OF zparticipant_05,
          ls_participant   TYPE zparticipant_05,
          lt_regs          TYPE TABLE OF zregistration_05,
          ls_reg           TYPE zregistration_05,
          lv_ts            TYPE timestampl.

    "===============================================================
    " DELETE OLD DATA
    "===============================================================
    DELETE FROM zregistration_05.
    out->write( |Deleted Registrations: { sy-dbcnt }| ).

    DELETE FROM zparticipant_05.
    out->write( |Deleted Participants: { sy-dbcnt }| ).

    DELETE FROM zevent_05.
    ...
    INSERT zevent_05 FROM TABLE @lt_events.
    ...
    DATA(first_names) = VALUE stringtab(
      ( |Hanna| ) ( |Marius| ) ( |Julian| ) ( |Lebron| )
      ( |Curry| ) ( |Jackson| ) ( |Michael| ) ( |Birke| )
    ).

    DATA(last_names) = VALUE stringtab(
      ( |Ling| ) ( |Lang| ) ( |Moin| ) ( |Hoffmann| )
    ...
    INSERT zparticipant_05 FROM TABLE @lt_participants.
    ...
    INSERT zregistration_05 FROM TABLE @lt_regs.
